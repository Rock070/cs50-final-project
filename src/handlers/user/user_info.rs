...
#[utoipa::path(
  ...
  responses(
      (status = 200, description = HttpResponseCode::Success.to_message(), body = AppHttpResponseUserInfoResponse, example = json!({"message": HttpResponseCode::Success.to_message(), "code": HttpResponseCode::Success.to_str(), "data": {"id": "1234567890", "username": "test", "password": "test", "email": "test@example.com"}})),
